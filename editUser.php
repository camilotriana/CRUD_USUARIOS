        ...
        <form method="post">
            <div class="row g-3 mt-3">
                ...
                <div class="col-lg-6">
                    ...
                    <input type="text" class="form-control" id="name" name="name" maxlength="255" required value="<?= $user->getNombres() ?>">
                </div>

                <div class="col-lg-6">
                    <label for="last_name" class="form-label">Apellidos</label>
                    <input type="text" class="form-control" id="last_name" name="last_name" maxlength="255" required value="<?= $user->getApellidos() ?>">
                </div>
